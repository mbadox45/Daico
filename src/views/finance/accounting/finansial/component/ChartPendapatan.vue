...
<template>
    <div class="grid">
        <div v-for="(item, index) in listChart" :key="index" :class="index == (listChart.length - 1) && listChart.length % 2 !== 0 ? 'col-12' : 'col-12 xl:col-6'">
            <div class="bg-white p-4 border-round shadow-3 flex flex-column gap-4 w-full">
                <div class="flex justify-content-between border-bottom-1 border-gray-300 pb-1">
                    <span class="font-bold text-base uppercase">{{ item.name }}</span>
