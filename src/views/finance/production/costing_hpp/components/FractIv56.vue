<script setup>
    ...
    import {loadFrakIV56_CostingHppController} from '@/controller/production/CostingHppController.js'
    ...
    const loadData = async() => {
        ...
        try {
            const response = props.dummy56;
            const frak = await loadFrakIV56_CostingHppController(response);
    ...
    watch(() => props.dummy56, loadData, { immediate: true });
