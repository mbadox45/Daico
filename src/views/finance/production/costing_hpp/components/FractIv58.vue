<script setup>
    ...
    import {loadFrakIV58_CostingHppController} from '@/controller/production/CostingHppController.js'
    ...
    const loadData = async() => {
        ...
        try {
            const response = props.dummy58;
            const frak = await loadFrakIV58_CostingHppController(response);
            ...
            total_frak.value = {total_value: 0, rp_kg: 0,}
            loadingTable.value = false
        }
    }

    watch(() => props.dummy58, loadData, { immediate: true });
