    ...
    const saveData = async () => {
        ...
        if (forms.value.name != null) {
            ...
            if (status_form.value == 'add') {
                const response = await BulkyProdMaster.addBulky(forms.value);
                const load = response.data;
                ...
                const response = await BulkyProdMaster.updateBulky(forms.value.id, forms.value);
                const load = response.data;
                if (load.success == true) {
                    messages.value = [
...
<template>
    <div class="flex-auto flex flex-column gap-3 p-3 bg-white shadow-3">
        <span class="font-medium text-xl">Master Bulky Produksi</span>
                    ...
                    <div class="flex flex-column md:flex-row align-items-center p-3 w-full border-1 my-2 border-round border-gray-300">
                        ...
                        <div class="flex-1 text-center md:text-left">
                            ...
                            <div class="flex align-items-center">
                                ...
                                <span class="font-normal text-gray-600">Bulk</span>
                            </div>
                        </div>
